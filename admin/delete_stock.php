...
<body>
    <?php
        ...
        if($login == true) {
            ...
            echo "<h1>Delete Stock</h1>";
            echo "</div>";

            echo "<section class='delete-section'>";
            echo "<p>Are you sure you want to delete this stock?</p>";
            echo "<a href='delete_stock.php?stockID=$stockID&confirm=yes' class='btn-confirm'>Yes</a>";
            echo "<a href='stock.php' class='btn-cancel'>No</a>";
            echo "</section>";
