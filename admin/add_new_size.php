...
$currentPage = "add_new_size.php";
include './logInCheck.php';

if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_size'])) {
    $sizeName = $_POST['sizeName'];
    $conn->query("INSERT INTO size (sizeName) VALUES ('$sizeName')");
...
<body>
    ...
    if($login):
        ...
        echo "<div class='page-header'><h1>Add New Size</h1><div class='header-actions'></div></div>";
        echo "<section class='add-section'>";
        echo "<form method='POST' style='display:flex;gap:15px;align-items:end;flex-wrap:wrap;'>";
        echo "<div class='form-group' style='flex:1;min-width:200px;'><label>Size Name:</label><input type='text' name='sizeName' required></div>";
        echo "<button type='submit' name='add_size' class='btn-submit' style='height:fit-content;padding:10px 20px;width:auto;'>Add Size</button>";
