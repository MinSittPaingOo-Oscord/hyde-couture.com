...
if(isset($_POST['addressID']) && isset($_POST['accountID'])){
...
<body>
    <?php
        ...
        if($login == true) {
            ...
            echo "<form class='selection-form' method='POST' action='registered_customer_step4.php' id='signup-form'>";
            ...
            echo "<input type='hidden' value='" . htmlspecialchars($accountID) . "' name='accountID'>";
            echo "<input type='hidden' value='" . htmlspecialchars($addressID) . "' name='addressID'>";
            ...
            echo "<form method='POST' action='registered_customer_step2.php' style='margin:0;'>";
            echo "<input type='hidden' name='accountID' value='" . htmlspecialchars($accountID) . "'>";
            echo "<button type='submit' class='btn-back'>Back</button>";
            echo "</form>";
