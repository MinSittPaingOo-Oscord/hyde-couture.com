...
if (isset($_POST['orderID'])) {
    ...
    if ($stmt->execute()) {
        ...
        $redirect_url = "specific_manual_order_non_registered.php?orderID=$orderID";
        if ($error_code) {
        ...
        $stmt->close();
        header("Location: specific_manual_order_non_registered.php?orderID=$orderID&error=update_failed");
        exit;
    }
}
$conn->close();
