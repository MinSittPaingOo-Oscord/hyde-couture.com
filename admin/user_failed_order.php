...
$query = "SELECT * FROM orderr JOIN account ON orderr.accountID = account.accountID WHERE orderr.orderStatus = 3 $whereDate AND orderr.accountID = $userID ORDER BY orderr.orderDate DESC";
...
<body>
    <?php
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<div class='no-orders'>No failed orders at the moment.</div>";
        }
