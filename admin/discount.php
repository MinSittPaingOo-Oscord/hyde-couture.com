...
$query = "SELECT * FROM discount JOIN product ON discount.productID = product.productID";
...
<body>
    <?php
        ...
        echo "<h1>Discount Management</h1>";
        echo "<div class='header-actions'>";
        echo "<button onclick=\"window.location.href='add_new_discount.php'\"><i class='fa fa-plus'></i> Add New Discount</button>";
        echo "</div>";
        echo "</div>";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<th>Discount Start From</th>";
            echo "<th>Discount End</th>";
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td data-label='Product ID'>".$row['productID']."</td>";
                echo "<td data-label='Product Name'>".$row['productName']."</td>";
                echo "<td data-label='Discount Start From'>".$row['range1']."</td>";
                echo "<td data-label='Discount End'>".$row['range2']."</td>"; //will show blank if this is NULL
                echo "<td data-label='Percentage'>".$row['percentage']." %</td>";
                echo "<td data-label='Actions'>";
                echo "<a href='edit_discount.php?discountID=".$row['discountID']."' class='btn-edit'>Edit</a>";
                echo "<a href='delete_discount.php?discountID=".$row['discountID']."' class='btn-delete'>Delete</a>";
                echo "</td>";
                echo "</tr>";
            }   
            ...
            echo "<div class='no-stock'>No discount items available.</div>";
        }
