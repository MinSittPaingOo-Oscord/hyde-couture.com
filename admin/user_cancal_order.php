...
$currentPage = "user_cancal_order.php";
...
$query = "SELECT * FROM orderr JOIN account ON orderr.accountID = account.accountID WHERE orderr.orderStatus = 6 $whereDate AND orderr.accountID = $userID ORDER BY orderr.orderDate DESC";
...
<head>
    ...
    <title>User Cancal Orders</title>
