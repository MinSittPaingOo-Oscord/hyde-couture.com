...
<body>
    <?php
        ...
        if($login == true) {
            ...
            echo "<a href='specific_manual_order_non_registered.php?orderID={$orderID}' class='btn-back'>← Back to Order</a>";
            echo "</div>";
            ...
            echo "<form class='selection-form' method='POST' action='add_order_items_action_non_registered.php'>";
