...
| ----------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lin Khant Min Maung** | Frontend Developer                                         | Responsible for responsive frontend design on the user-side website. His main contributions include improving the responsive layout and user interface for key pages such as the navigation bar, registration page, login page, profile page, specific product page, and cart page.                                                                                                                                                                                                                               |
| **Nandar Kyaw**         | Frontend Developer                                         | Responsible for responsive frontend design on the user-side website. Her main contributions include working on the home page, footer section, order list page, order details page, and other user-side interface components.                                                                                                                                                                                                                               |
