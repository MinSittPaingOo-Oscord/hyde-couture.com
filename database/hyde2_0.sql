...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2026 at 09:26 PM
...
(7, 'HYDE SIGNATURE OVERSIZED HOODIE', 145000, 125000, '2026-03-20', 'Premium heavyweight French terry cotton hoodie. Boxy oversized fit with ribbed cuffs and hem. Signature VERVESV embroidery on front and back. Cut and sewn in Myanmar.', 2, 0),
(8, 'HYDE UTILITY CARGO SWEATPANTS', 95000, NULL, '2026-03-20', 'Relaxed fit cargo sweatpants featuring multiple utility pockets. Made from premium 350gsm cotton fleece for ultimate comfort. Elastic waistband with drawstring. Designed in Bangkok, sewn in Yangon.', 3, 1),
(9, 'HYDE VINTAGE TRUCKER JACKET', 320000, 280000, '2026-03-20', 'Classic trucker style jacket in premium genuine leather. Lined with soft cotton. Snap button closure, multiple pockets. Timeless streetwear essential. Made in Myanmar.', 5, 0),
(32, 'HYDE REFLECTIVE LOGO ZIP HOODIE', 185000, NULL, '2026-03-21', 'Heavyweight 380gsm fleece zip-up hoodie. Reflective VERVESV logo on chest and back. Kangaroo pocket, ribbed cuffs. Designed in Bangkok.', 3, 1),
(33, 'HYDE WIDE-LEG BAGGY JEANS', 145000, 125000, '2026-03-21', 'Light wash baggy wide-leg jeans. Low-rise relaxed fit with destroyed details at knees. 100% cotton denim.', 2, 0),
(34, 'HYDE MINIMAL BOMBER JACKET', 220000, 195000, '2026-03-21', 'Navy blue lightweight bomber. Satin finish outer, quilted lining. Ribbed collar/cuffs/hem. Hidden pockets.', 4, 0),
(35, 'HYDE CROPPED HEAVY SWEATSHIRT', 95000, NULL, '2026-03-21', 'Boxy cropped sweatshirt in grey melange. 400gsm loopback cotton. Dropped shoulders, ribbed trim.', 2, 0),
(36, 'HYDE SIGNATURE EMBROIDERED BEANIE', 45000, NULL, '2026-03-21', 'Classic cuffed beanie in black acrylic knit. Flat embroidered VERVESV logo. One size fits most.', 1, 0),
(37, 'HYDE FLAME GRAPHIC TEE', 75000, 65000, '2026-03-21', 'Oversized 210gsm cotton tee with flame graphic print. Distressed wash finish. Cut & sewn in Yangon.', 1, 0),
(38, 'HYDE HEAVY FLEECE ZIP HOODIE', 195000, NULL, '2026-03-21', 'Premium 400gsm fleece zip hoodie with contrast lining. Embroidery logo on sleeve.', 3, 1),
(39, 'HYDE BAGGY CARGO JEANS', 155000, 135000, '2026-03-21', 'Dark wash baggy jeans with cargo pockets and adjustable hem. Streetwear essential.', 2, 0),
(40, 'HYDE SATIN BOMBER JACKET', 230000, 210000, '2026-03-21', 'Olive satin bomber jacket with quilted interior and ribbed details.', 4, 0),
(41, 'HYDE CROP TOP SWEATSHIRT', 85000, NULL, '2026-03-21', 'Women/unisex cropped heavy sweatshirt in sand beige. Perfect layering piece.', 2, 0),
(42, 'HYDE WINTER BEANIE WITH PATCH', 48000, NULL, '2026-03-21', 'Thick knit beanie with leather patch logo. Unisex accessory.', 1, 0),
(43, 'HYDE RELAXED JOGGERS', 105000, 95000, '2026-03-21', 'Heavy fleece joggers with side zip pockets and elastic cuffs.', 2, 0),
(44, 'HYDE OVERSIZED DENIM JACKET', 245000, 215000, '2026-03-21', 'Indigo oversized denim trucker jacket with vintage wash.', 4, 0),
(45, 'HYDE LIGHTWEIGHT WINDBREAKER', 175000, NULL, '2026-03-21', 'Olive tech windbreaker with UPF50+ and hidden pockets.', 3, 0),
(46, 'HYDE CREW NECK SWEATER', 135000, 125000, '2026-03-21', 'Heavyweight 420gsm crew neck sweater in grey melange.', 2, 0),
(47, 'HYDE 3-PACK GRAPHIC TEE SET', 165000, NULL, '2026-03-21', 'Set of 3 oversized graphic tees (black, white, olive).', 1, 1),
(48, 'HYDE REFLECTIVE RUNNING JACKET', 265000, 235000, '2026-03-21', 'Tech reflective jacket with zip-off hood. Perfect for night runs.', 3, 0),
(49, 'HYDE VINTAGE WASH JEANS', 158000, 138000, '2026-03-21', 'Medium wash straight-leg jeans with subtle distressing.', 2, 0),
(50, 'HYDE LEATHER TRUCKER HAT', 65000, NULL, '2026-03-21', 'Premium leather 6-panel trucker hat with embroidered logo.', 1, 0),
(51, 'HYDE TECH CARGO SHORTS', 98000, 88000, '2026-03-21', 'Relaxed cargo shorts with multiple utility pockets and drawstring.', 1, 0);
...
--
ALTER TABLE `photo`
  MODIFY `photoID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `productxcategory`
  MODIFY `productxcategoryID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;

--
-- AUTO_INCREMENT for table `relatedproduct`
--
ALTER TABLE `relatedproduct`
  MODIFY `relatedProductID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
