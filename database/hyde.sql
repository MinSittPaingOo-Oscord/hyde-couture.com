...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2026 at 12:36 AM
...
CREATE TABLE `address` (
  ...
  `mapLink` varchar(2000) DEFAULT NULL,
...
CREATE TABLE `orderitem` (
  ...
  `isStockReduce` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `orderr` (
  `orderID` int(11) NOT NULL,
  `paymentValid` tinyint(4) DEFAULT NULL,
  ...
  `manualCustomerName` varchar(2000) DEFAULT NULL,
  `manualNote` longtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `paymentslip` (
  `paymentSlipID` int(11) NOT NULL,
  `paymentSlip` int(11) NOT NULL,
  `orderID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `productxcategory` (
  `productxcategoryID` int(11) NOT NULL,
  `productID` int(11) NOT NULL,
  `categoryID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `trackingstatus` (
  `trackingStatusID` int(11) NOT NULL,
...
--
ALTER TABLE `color`
  MODIFY `colorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `discount`
--
ALTER TABLE `discount`
  MODIFY `discountID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `paymentslip`
  MODIFY `paymentSlipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `photo`
  MODIFY `photoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
...
--
ALTER TABLE `productxcategory`
  MODIFY `productxcategoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;

--
-- AUTO_INCREMENT for table `relatedproduct`
--
ALTER TABLE `relatedproduct`
  MODIFY `relatedProductID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
...
--
ALTER TABLE `stock`
  MODIFY `stockID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT for table `trackingstatus`
--
ALTER TABLE `trackingstatus`
  MODIFY `trackingStatusID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `account`
  ...
  ADD CONSTRAINT `account_ibfk_2` FOREIGN KEY (`profile`) REFERENCES `photo` (`photoID`);

--
-- Constraints for table `address`
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`accountID`) REFERENCES `account` (`accountID`);
...
--
ALTER TABLE `favourite`
  ADD CONSTRAINT `favourite_ibfk_1` FOREIGN KEY (`accountID`) REFERENCES `account` (`accountID`),
...
--
ALTER TABLE `orderitem`
  ADD CONSTRAINT `orderitem_ibfk_1` FOREIGN KEY (`orderID`) REFERENCES `orderr` (`orderID`),
  ADD CONSTRAINT `orderitem_ibfk_2` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`),
  ADD CONSTRAINT `orderitem_ibfk_3` FOREIGN KEY (`color`) REFERENCES `color` (`colorID`),
  ADD CONSTRAINT `orderitem_ibfk_4` FOREIGN KEY (`size`) REFERENCES `size` (`sizeID`);

--
-- Constraints for table `orderr`
--
ALTER TABLE `orderr`
  ADD CONSTRAINT `orderr_ibfk_1` FOREIGN KEY (`accountID`) REFERENCES `account` (`accountID`),
  ADD CONSTRAINT `orderr_ibfk_2` FOREIGN KEY (`orderStatus`) REFERENCES `orderstatus` (`orderStatusID`),
  ADD CONSTRAINT `orderr_ibfk_3` FOREIGN KEY (`paymentStatus`) REFERENCES `paymentstatus` (`paymentStatusID`),
  ADD CONSTRAINT `orderr_ibfk_4` FOREIGN KEY (`trackingStatus`) REFERENCES `trackingstatus` (`trackingStatusID`),
  ADD CONSTRAINT `orderr_ibfk_5` FOREIGN KEY (`paymentType`) REFERENCES `paymenttype` (`paymentTypeID`),
  ADD CONSTRAINT `orderr_ibfk_6` FOREIGN KEY (`addressID`) REFERENCES `address` (`addressID`);

--
-- Constraints for table `paymentslip`
--
ALTER TABLE `paymentslip`
  ADD CONSTRAINT `paymentslip_ibfk_1` FOREIGN KEY (`paymentSlip`) REFERENCES `photo` (`photoID`),
  ADD CONSTRAINT `paymentslip_ibfk_2` FOREIGN KEY (`orderID`) REFERENCES `orderr` (`orderID`);

--
-- Constraints for table `photo`
--
ALTER TABLE `photo`
  ADD CONSTRAINT `photo_ibfk_1` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);

--
-- Constraints for table `productxcategory`
--
ALTER TABLE `productxcategory`
  ADD CONSTRAINT `productxcategory_ibfk_1` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`),
  ADD CONSTRAINT `productxcategory_ibfk_2` FOREIGN KEY (`categoryID`) REFERENCES `category` (`categoryID`);

--
-- Constraints for table `relatedproduct`
--
ALTER TABLE `relatedproduct`
  ADD CONSTRAINT `relatedproduct_ibfk_1` FOREIGN KEY (`productID1`) REFERENCES `product` (`productID`),
  ADD CONSTRAINT `relatedproduct_ibfk_2` FOREIGN KEY (`productID2`) REFERENCES `product` (`productID`);
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `review_ibfk_2` FOREIGN KEY (`accountID`) REFERENCES `account` (`accountID`);
...
ALTER TABLE `stock`
  ...
  ADD CONSTRAINT `stock_ibfk_2` FOREIGN KEY (`sizeID`) REFERENCES `size` (`sizeID`),
  ADD CONSTRAINT `stock_ibfk_3` FOREIGN KEY (`colorID`) REFERENCES `color` (`colorID`);
COMMIT;
